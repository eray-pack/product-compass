...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Stopamine — The honest recovery system for any addiction" },
      { name: "description", content: "Track and quit multiple addictions with psychological tools, an AI recovery coach, and an honest streak system that tells you the truth." },
      { property: "og:title", content: "Stopamine — The honest recovery system for any addiction" },
      { name: "twitter:title", content: "Stopamine — The honest recovery system for any addiction" },
      { property: "og:description", content: "Track and quit multiple addictions with psychological tools, an AI recovery coach, and an honest streak system that tells you the truth." },
      { name: "twitter:description", content: "Track and quit multiple addictions with psychological tools, an AI recovery coach, and an honest streak system that tells you the truth." },
